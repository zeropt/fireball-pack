...
# Fireballs
execute as @e[type=minecraft:snowball,nbt={Item:{tag:{fireball:1b}}}] at @s run function fireballs:launch_fireball
kill @e[type=minecraft:snowball,nbt={Item:{tag:{fireball:1b}}}]
execute as @e[type=minecraft:fireball] at @s run kill @s[y=512,dy=0]

# Small Fireballs
execute as @e[type=minecraft:snowball,nbt={Item:{tag:{small_fireball:1b}}}] at @s run function fireballs:launch_small_fireball
...
# Dragon Fireballs
execute as @e[type=minecraft:snowball,nbt={Item:{tag:{dragon_fireball:1b}}}] at @s run function fireballs:launch_dragon_fireball
