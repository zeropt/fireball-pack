...
data modify entity @e[type=minecraft:small_fireball,limit=1,sort=nearest] Owner set from entity @s Owner
...
execute store result entity @e[type=minecraft:small_fireball,limit=1,sort=nearest] Motion[0] double 0.0005 run data get entity @s Motion[0] 1000
execute store result entity @e[type=minecraft:small_fireball,limit=1,sort=nearest] Motion[1] double 0.0005 run data get entity @s Motion[1] 1000
execute store result entity @e[type=minecraft:small_fireball,limit=1,sort=nearest] Motion[2] double 0.0005 run data get entity @s Motion[2] 1000
